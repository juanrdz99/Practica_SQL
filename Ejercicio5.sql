...
SELECT
  ...
  ARRAY_AGG(document_type IGNORE NULLS LIMIT 1)[OFFSET(0)] AS document_type,
  ARRAY_AGG(document_identification IGNORE NULLS LIMIT 1)[OFFSET(0)] AS document_identification,
